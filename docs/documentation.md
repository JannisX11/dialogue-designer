...
![Directions page](directions.png)
...
You can use Minecraft's [Formatting codes](https://minecraft.wiki/w/Formatting_codes) to add formatting to your text, including making your text bold, italic, or changing the color.
Simply enter the section sign (`§`), followed by a [specific number or letter](https://minecraft.wiki/w/Formatting_codes#Color_codes), into the text field, ahead of the word that you want to format. After the word, you can put `§r` to reset the formatting.
...
![Preview of the text above, but with certain words formatted in matching colors](formatting.png)
...
Let's now create a second language file. The name defaults to `de_DE`, which is the code for German. But you can edit the code at the top of your screen to something like `it_IT` for Italian, etc. ([Full List](https://minecraft.wiki/w/Language)). We'll also add our translation string into this file, but translated into the respective language:
...
Once you are done, press the Confirm button. If there are JSON syntax errors, a red error message will show up and prevent you from saving your changes. Fix the JSON error to proceed.

You can learn more about the rawtext format here: [Raw JSON text format](https://minecraft.wiki/w/Raw_JSON_text_format#Bedrock_Edition)
